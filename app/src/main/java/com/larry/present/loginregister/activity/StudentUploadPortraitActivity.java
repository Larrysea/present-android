...
public class StudentUploadPortraitActivity extends Activity {
    ...
    final static String TAG = StudentUploadPortraitActivity.class.toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path = "http://192.168.1.102:8080/present/resource/ic_search.png";
    ...
    public void uploadFile() {
        ...
        String portraitPath = Environment.getExternalStorageDirectory() + "/here/portrait.jpg";
        //服务器端地址
        String url = "http://192.168.1.102:8080/present/upload";
        //手机端要上传的文件，首先要保存你手机上存在该文件
        AsyncHttpClient httpClient = new AsyncHttpClient();
        RequestParams param = new RequestParams();
        try {
            param.put("file", new File(portraitPath));
            ...
            httpClient.post(url, param, new AsyncHttpResponseHandler() {
                ...
                public void onFailure(Throwable arg0, String arg1) {
                    ...
                    Log.e(TAG, arg0.getMessage() + "   " + arg1);
